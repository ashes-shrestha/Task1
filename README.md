...
3. Run command:
  ...
  **For Linux/Mac**
   ...
   **If command didn't work, replace the <directory path> with the full directory path of repository directory**
    
   docker run -it --rm --name Task1 -v <directory path>:/home/test1 -w /home/test1 php php task1.php
